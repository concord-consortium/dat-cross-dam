    ...
    <div className={attributionDisplayClass} onClick={this.toggleAttribution}>
      <div className="attribution-text">
        <div className="small-logo" onClick={this.toggleAttribution} />
          ...
          <div>Copyright © 2018 The Concord Consortium. All rights reserved.
          ...
          Please see <a href="https://github.com/concord-consortium/dat-cross-farm/blob/master/LICENSE"
            ...
            Please provide attribution to the Concord Consortium and the URL
            URL <a href="https://concord.org" target="_blank" rel="noopener">https://concord.org</a>.</div>
      </div>
    </div>
    </div>
   );
